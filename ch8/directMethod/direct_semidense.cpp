...
bool poseEstimationDirect ( const vector< Measurement >& measurements, cv::Mat* gray, Eigen::Matrix3f& K, Eigen::Isometry3d& Tcw )
{
    ...
    std::unique_ptr<DirectBlock::LinearSolverType> linearSolverPtr(linearSolver);
    DirectBlock* solver_ptr = new DirectBlock ( std::move(linearSolverPtr) );
    std::unique_ptr<DirectBlock> solverPtr(solver_ptr);
    // g2o::OptimizationAlgorithmGaussNewton* solver = new g2o::OptimizationAlgorithmGaussNewton( solver_ptr ); // G-N
    g2o::OptimizationAlgorithmLevenberg* solver = new g2o::OptimizationAlgorithmLevenberg ( std::move(solverPtr) ); // L-M
